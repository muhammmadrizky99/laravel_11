...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('dashboard-berita.create') }}" class="btn btn-outline-success">Entry Data Berita +</a>
        <form class="d-flex position-relative" role="search" method="GET" action="{{ route('dashboard-berita.index') }}">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
                <form action="/dashboard-berita/{{ $item->id }}" method="POST" class="d-inline">
                    @method('DELETE')
                    @csrf
                ...
                <a href="/dashboard-berita/{{ $item->id }}/edit" class="btn btn-warning">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
