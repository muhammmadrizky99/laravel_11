...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('dashboard-prodi.create') }}" class="btn btn-outline-success">Entry Prodi +</a>
        <form class="d-flex position-relative" role="search" method="GET" action="{{ route('dashboard-prodi.index') }}">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="/dashboard-prodi/{{ $prodi->id }}/edit" class="btn btn-warning">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
